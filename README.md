...
1. **下载安装包**：前往 **[GitHub Releases 页面](https://github.com/linrol/teams-wake/releases/latest)** 下载最新的 **[Teams Wake-1.0.1.dmg](https://github.com/linrol/teams-wake/releases/download/v1.0.1/Teams.Wake-1.0.1.dmg)**（若下载缓慢，亦可直接访问 [Release v1.0.1 详情页](https://github.com/linrol/teams-wake/releases/tag/v1.0.1)）。
